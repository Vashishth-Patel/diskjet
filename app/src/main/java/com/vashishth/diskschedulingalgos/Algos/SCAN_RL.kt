...
var scanSequenceRl = ArrayList<Int>()

fun SCAN_RL(arr: ArrayList<Int>, head: Int, tail :Int) : Int {
    var head = head
    var direction = "left"
    var seek_count = 0
    var distance: Int
    ...
    scanSequenceRl.clear()
    seek_sequence.forEach {
        scanSequenceRl.add(it)
    }
    return seek_count
}

fun scanSequenceRl():ArrayList<Int>{
    return scanSequenceRl
}